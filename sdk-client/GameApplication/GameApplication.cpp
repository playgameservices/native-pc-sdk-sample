...
public:
    ...
    GameApplication() {
        ...
        wc.lpszClassName = L"OpenGLGameWindow";
        RegisterClass(&wc);
        hwndMain = CreateWindowEx(0, L"OpenGLGameWindow", L"OpenGL Game",
            WS_OVERLAPPEDWINDOW | WS_VISIBLE, CW_USEDEFAULT, CW_USEDEFAULT,
            800, 600, NULL, NULL, GetModuleHandle(NULL), this);
        if (!hwndMain) {
    ...
    void OnBillingSDKButtonClick() {
        ...
        //mBillingSdk = new BillingSdkWindow(hInstance);
        //mBillingSdk->Show();
        // Trigger a repaint (OpenGL scene)
        InvalidateRect(hwndMain, NULL, FALSE);  // Only invalidate the OpenGL area
        UpdateWindow(hwndMain);
    }
    ...
    static LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
        ...
        case WM_CREATE: {
            ...
            app = (GameApplication*)pCreate->lpCreateParams;
            return 0;
        }
        case WM_PAINT: {
            PAINTSTRUCT ps;
